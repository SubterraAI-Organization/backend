...
function GenerateMask() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/datasets/1/images/`, formData, {
        headers: {
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        await axios.post(
          `${import.meta.env.VITE_BACKEND_URL}/api/datasets/1/images/${imageId}/masks/`,
          {},
          {
            headers: {
              Authorization: import.meta.env.VITE_AUTHORIZATION,
