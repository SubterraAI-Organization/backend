...
export const imageApi = {
  ...
  delete: async (datasetId, imageId) => {
    await axios.delete(`${API_URL}/api/datasets/${datasetId}/images/${imageId}/`, {
      headers: getHeaders(),
    });
  },
};
...
export const maskApi = {
  ...
  create: async (datasetId, imageId, modelType) => {
    const response = await axios.post(
      `${API_URL}/api/datasets/${datasetId}/images/${imageId}/masks/`,
...
export const modelApi = {
  ...
  update: async (id, formData) => {
    const response = await axios.patch(`${API_URL}/api/models/${id}/`, formData, {
      headers: {
        ...getHeaders(),
        "Content-Type": "multipart/form-data",
      },
...
export const handleApiError = (error, setErrorFunction) => {
  ...
  if (error.response) {
    ...
    setErrorFunction("No response received from server. Please check your connection.");
  } else {
